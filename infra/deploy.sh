...
VNET_NAME="${VNET_NAME:-}"
AI_SUBNET_NAME="${AI_SUBNET_NAME:-aiSubnet}"
APP_SERVICES_SUBNET_NAME="${APP_SERVICES_SUBNET_NAME:-appServicesSubnet}"
DATABASE_SUBNET_NAME="${DATABASE_SUBNET_NAME:-databaseSubnet}"
EXISTING_BASTION_HOST_RESOURCE_ID="${EXISTING_BASTION_HOST_RESOURCE_ID:-}"
EXISTING_AUTOMATION_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_AUTOMATION_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_ODS_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_ODS_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_OMS_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_OMS_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_COGNITIVE_SERVICES_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_COGNITIVE_SERVICES_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_OPENAI_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_OPENAI_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_AI_SERVICES_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_AI_SERVICES_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_DOCUMENTS_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_DOCUMENTS_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_KEY_VAULT_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_KEY_VAULT_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_AZURE_MONITOR_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_AZURE_MONITOR_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_BLOB_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_BLOB_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_QUEUE_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_QUEUE_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_TABLE_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_TABLE_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
EXISTING_FILE_PRIVATE_DNS_ZONE_RESOURCE_ID="${EXISTING_FILE_PRIVATE_DNS_ZONE_RESOURCE_ID:-}"
...
deploy_bicep() {
    ...
    PARAMS=(
        ...
        "aiSubnetName=$AI_SUBNET_NAME"
        "appServicesSubnetName=$APP_SERVICES_SUBNET_NAME"
    ...
    REUSE_CONFIG+="\"existingBastionHostResourceId\":\"$EXISTING_BASTION_HOST_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingAutomationPrivateDnsZoneResourceId\":\"$EXISTING_AUTOMATION_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingOdsPrivateDnsZoneResourceId\":\"$EXISTING_ODS_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingOmsPrivateDnsZoneResourceId\":\"$EXISTING_OMS_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingCognitiveServicesPrivateDnsZoneResourceId\":\"$EXISTING_COGNITIVE_SERVICES_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingOpenAiPrivateDnsZoneResourceId\":\"$EXISTING_OPENAI_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingAiServicesPrivateDnsZoneResourceId\":\"$EXISTING_AI_SERVICES_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingDocumentsPrivateDnsZoneResourceId\":\"$EXISTING_DOCUMENTS_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingKeyVaultPrivateDnsZoneResourceId\":\"$EXISTING_KEY_VAULT_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingAzureMonitorPrivateDnsZoneResourceId\":\"$EXISTING_AZURE_MONITOR_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingBlobPrivateDnsZoneResourceId\":\"$EXISTING_BLOB_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingQueuePrivateDnsZoneResourceId\":\"$EXISTING_QUEUE_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingTablePrivateDnsZoneResourceId\":\"$EXISTING_TABLE_PRIVATE_DNS_ZONE_RESOURCE_ID\","
    REUSE_CONFIG+="\"existingFilePrivateDnsZoneResourceId\":\"$EXISTING_FILE_PRIVATE_DNS_ZONE_RESOURCE_ID\","
